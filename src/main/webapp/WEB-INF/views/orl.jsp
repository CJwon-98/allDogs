			...
			<!-- Header -->
				<section id="header">
					<div class="container">
						...
						<!-- Logo -->
							<h1 id="logo"><a href="index.html">AllDogs</a></h1>
							...
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										...
										<p>This is <strong>AllDogs</strong>, a free, fully responsive site template
							...
							<div class="col-4 col-6-medium col-12-small">
								...
								<!-- Feature -->
									<section>
										...
										<p><a href="http://html5up.net">HTML5 UP</a> is a side project of <a href="http://twitter.com/ajlkn">AJÃ¢ÂÂs</a> (= me).
								...
								<div id="content" class="col-8 col-12-medium">
									...
									<!-- Post -->
										<article class="box post">
											<header>
												<h2><a href="#">I donÃ¢ÂÂt want to say <strong>itÃ¢ÂÂs the aliens</strong> ...<br />
												but itÃ¢ÂÂs the aliens.</a></h2>
											</header>
